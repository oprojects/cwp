...
\begin{itemize}
 ...
 \item Transferable skills (related to bridges to other communities)
...
To be more specific, we identify three broad sets of students, classified by experience level, recognizing that even within these groups there will be people who will learn at different speeds and with differing depths of understanding.
...
\begin{itemize}
 ...
 \item ``incentivize''trust metrics (data driven tests, etc)
